...
def conservation_loss(pred_WD, input_WD, data, BC):
    ...
    Args:
        pred_WD (Tensor): Predicted water depths, shape [N, num_water_cells
        input_WD (Tensor): Input water depths, shape [N, num_water_cells]
        data (Data): Graph data object containing area and node_ptr
        BC (Tensor): Boundary conditions tensor,,
    """
